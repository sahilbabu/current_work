...
?>
    ...
    <article id="content" class="clearfix">
        ...
        <div class="clearfix rev minimal-2">
                ...
                <div id="rev_slider_1_1" class="rev_slider" style="display: none;">
                    <ul>
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                            <img src="<?php print path_to_theme();?>/images/slider/bg.jpg" alt="bg">
                            <img src="<?php print path_to_theme();?>/images/slider/circle_position_02.png"	alt="Circle position 0">
                            <div class="tp-caption fade" data-x="0" data-y="0" data-speed="500" data-start="500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/circle_position_02.png" alt="Circle position 0">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/circle_position_11.png"	alt="Circle position 1">
                            <div class="tp-caption fade" data-x="0" data-y="0" data-speed="500" data-start="2250" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/circle_position_11.png"	alt="Circle position 1">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/circle_position_2.png" alt="Circle position 2">
                            <div class="tp-caption fade" data-x="0" data-y="0" data-speed="500" data-start="3500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/circle_position_2.png" alt="Circle position 2">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/circle_position_3.png" alt="Circle position 3">
                            <div class="tp-caption fade" data-x="0" data-y="0" data-speed="500" data-start="4750" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/circle_position_3.png" alt="Circle position 3">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/hand1.png" alt="Hand new">
                            <div class="tp-caption lfr" data-x="433" data-y="86" data-speed="1000" data-start="1500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/hand1.png" alt="Hand new">
                            </div>
                        </li>
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="5000">
                            <img src="<?php print path_to_theme();?>/images/slider/bg.jpg" alt="bg"> 
                            <img src="<?php print path_to_theme();?>/images/slider/ipad3.png" alt="iPad new">
                            <div class="tp-caption lft" data-x="320" data-y="47" data-speed="500" data-start="500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/ipad3.png" alt="iPad new">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/iphone_hor3.png" alt="iPhone horizontal new">
                            <div class="tp-caption lfl" data-x="242" data-y="187" data-speed="500" data-start="500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/iphone_hor3.png" alt="iPhone horizontal new">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/notebook1.png" alt="Notebook">
                            <div class="tp-caption lfr" data-x="370" data-y="130" data-speed="500" data-start="500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/notebook1.png" alt="Notebook">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/iphone_ver2.png" alt="iPhone vertical new">
                            <div class="tp-caption lft" data-x="0" data-y="155"	data-speed="1500" data-start="1500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/iphone_ver2.png" alt="iPhone vertical new">
                            </div>
                        </li>
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                            <img src="<?php print path_to_theme();?>/images/slider/bg.jpg"	alt="bg"> 
                            <img src="<?php print path_to_theme();?>/images/slider/first1.png" alt="_1">
                            <div class="tp-caption sfb" data-x="0" data-y="0" data-speed="300" data-start="500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/first1.png" alt="_1">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/second1.png" alt="_2">
                            <div class="tp-caption fade" data-x="0" data-y="0" data-speed="1000" data-start="1500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/second1.png" alt="_2">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/third1.png" alt="_3">
                            <div class="tp-caption fade" data-x="0" data-y="0" data-speed="600" data-start="2500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/third1.png" alt="_3">
                            </div>
                        </li>
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                            <img src="<?php print path_to_theme();?>/images/slider/bg.jpg" alt="bg"> 
                            <img src="<?php print path_to_theme();?>/images/slider/part1.png" alt="part1">
                            <div class="tp-caption sfb" data-x="68" data-y="69" data-speed="500" data-start="500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/part1.png" alt="part1">
                            </div> <img src="<?php print path_to_theme();?>/images/slider/part1.png" alt="part3">
                            <div class="tp-caption sfb" data-x="468" data-y="69" data-speed="500" data-start="900" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/part1.png" alt="part3">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/part1.png" alt="part4">
                            <div class="tp-caption sfb" data-x="668" data-y="69" data-speed="500" data-start="1100" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/part1.png" alt="part4">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/part5.png" alt="part5">
                            <div class="tp-caption sfb" data-x="69" data-y="143" data-speed="500" data-start="1300" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/part5.png" alt="part5">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/part6.png" alt="part6">
                            <div class="tp-caption sfb" data-x="468" data-y="143" data-speed="500" data-start="1500" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/part6.png" alt="part6">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/fade_all.png" alt="fader">
                            <div class="tp-caption fade" data-x="0" data-y="0" data-speed="1000" data-start="2000" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/fade_all.png" alt="fader">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/part2.png" alt="part2">
                            <div class="tp-caption sfb" data-x="269" data-y="68" data-speed="500" data-start="700" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/part2.png" alt="part2">
                            </div> 
                            <img src="<?php print path_to_theme();?>/images/slider/part_active1.png" alt="Active new">
                            <div class="tp-caption lfl" data-x="310" data-y="115" data-speed="1000" data-start="2000" data-easing="easeOutExpo">
                                <img src="<?php print path_to_theme();?>/images/slider/part_active1.png" alt="Active new">
                            </div>
                        </li>
                    </ul>
            ...
            <ul class="tabs clearfix">
                <li><i class="icon-award"></i>
                    <h3>Flexible Solutions</h3>
                    <h5>Let's Do Amazing</h5> <span></span></li>
                <li><i class="icon-mobile-1"></i>
                    <h3>Build It Your Way</h3>
                    <h5>Creative Development</h5> <span></span></li>
                <li><i class="icon-fire-station"></i>
                    <h3>We Save Your Time</h3>
                    <h5>Creative Development</h5> <span></span></li>
                <li><i class="icon-pencil-1"></i>
                    <h3>Easy, simple IT</h3>
                    <h5>Smart & Easy</h5> <span></span></li>
            </ul>
        </div>
        ...
        <header style="margin-bottom: 50px"
                class="sectionTitle clearfix con-pencil-1">
            <h3>
        ...
        <!-- Quote line -->
        <header style="margin-bottom: 45px" class="sectionTitle clearfix ">
            <h3>
                <i class="i-small icon-school"></i> <strong>In a hurry? No problem.</strong>
            </h3>
        </header>
        <section class="rbLine clearfix ">
